 ...
 *
 * 型号/代号来源（2026-08-11 已查证）：
 * - Galaxy Z Fold8 = SM-F976，代号 q8
 * - Galaxy Z Flip8 = SM-F776，代号 b8r
 * - Galaxy Z Fold7 = SM-F966，代号 q7
 * - Galaxy Z Flip7 = SM-F766，代号 b6r
 * - Galaxy S26 Ultra = SM-S93U，代号 a9e（S25U=SM-S938/a9）
...
object DeviceModels {
    ...
    val ALL: List<DeviceProfile> = listOf(
        // ==== Z Fold 系列 ====
        DeviceProfile("Galaxy Z Fold8", "SM-F9760", "q8", "q8zc", "Z Fold"),
        DeviceProfile("Galaxy Z Fold8 Ultra", "SM-F9780", "q8x", "q8xz", "Z Fold"),
        ...
        // ==== Z Flip 系列 ====
        DeviceProfile("Galaxy Z Flip8", "SM-F7760", "b8r", "b8rzc", "Z Flip"),
